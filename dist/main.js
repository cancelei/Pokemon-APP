...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://webpack_boiler-1/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _cardUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cardUtils.js */ \"./src/cardUtils.js\");\n/* harmony import */ var _homepagecounter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./homepagecounter.js */ \"./src/homepagecounter.js\");\n/* harmony import */ var _popup_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./popup.js */ \"./src/popup.js\");\n\n\n\n\n\n\nconst main = document.querySelector('.main');\nconst fetchPromises = [];\nconst MAXCARDS = 9;\n\nfor (let i = 1; i <= MAXCARDS; i += 1) {\n  const newCard = (0,_cardUtils_js__WEBPACK_IMPORTED_MODULE_1__.createCard)(i);\n  main.appendChild(newCard);\n\n  const fetchPromise = fetch(`https://pokeapi.co/api/v2/pokemon/${i}`)\n    .then((response) => response.json())\n    .then((data) => {\n      (0,_cardUtils_js__WEBPACK_IMPORTED_MODULE_1__.populateCard)(newCard, data);\n      (0,_homepagecounter_js__WEBPACK_IMPORTED_MODULE_2__.updateitemscount)();\n    });\n\n  fetchPromises.push(fetchPromise);\n}\n\nPromise.all(fetchPromises)\n  .then(() => {});\n\n//# sourceURL=webpack://webpack_boiler-1/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"95be7854a14a79a6febb.jpeg\";\n\n//# sourceURL=webpack://webpack_boiler-1/./src/img/download.jpeg?");
...
eval("module.exports = __webpack_require__.p + \"ced5220738fcbc8b88e8.png\";\n\n//# sourceURL=webpack://webpack_boiler-1/./src/img/heart.png?");

/***/ }),

/***/ "./src/img/hearthoverclick.png":
/*!*************************************!*\
  !*** ./src/img/hearthoverclick.png ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"eb522041ad22fdb03a8e.png\";\n\n//# sourceURL=webpack://webpack_boiler-1/./src/img/hearthoverclick.png?");
